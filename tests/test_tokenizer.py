...
def get_tokenizer_from_vocab_merges_path(
    ...
    # print("vocab[240] =", repr(vocab.get(240)))
    # print("vocab[159] =", repr(vocab.get(159)))
    # print("vocab[153] =", repr(vocab.get(153)))
    # print("vocab[131] =", repr(vocab.get(131)))
    # 测试函数中，输入的数据格式分别是：print(f"gpt's vocab: {vocab}") # 23747: b'vasive', 23748: b' hello', 
    # print(f"gpt's merges: {merges}") # (b' St', b'a'), (b' Col', b'ossus')
...
def test_roundtrip_single_unicode_character():
    ...
    test_string = "🙃"
    encoded_ids = tokenizer.encode(test_string)
    bs = b"".join(tokenizer.vocab[i] for i in encoded_ids)
    decoded_string = tokenizer.decode(encoded_ids)
    assert test_string == decoded_string
